...
public class DepopWebApiServiceImpl implements DepopWebApiService {
    ...
    @Override
    public SearchProductDto searchProducts(SearchProductRequestParameterDto search) {
        return webClient
                .get()
                .uri(
    ...
    @Override
    public SearchProductDto searchProducts() {
        return searchProducts(null);
    }

    @Override
    public UserProductViewDto getProductByName(String bearerToken, String productName) {
        return webClient
                .get()
    ...
    @Override
    public FollowRelationship getMyRelationshipWithUser(String bearerToken, Long contactId) {
        return webClient
                .get()
    ...
    @Override
    public Void followUser(String bearerToken, Long userId) {
         return webClient
                .put()
    ...
    @Override
    public Void unfollowUser(String bearerToken, Long userId) {
        return webClient
                .delete()
    ...
    @Override
    public Void likeProduct(String bearerToken, Long productId) {
        return webClient
                .put()
    ...
    @Override
    public Void unlikeProduct(String bearerToken, Long productId) {
        return webClient
                .delete()
    ...
    @Override
    public UserFollowerFollowingDto getUserFollower(Long userId, UserFollowerFollowingRequestParameterDto search) {
        return webClient
                .get()
                .uri(
    ...
    @Override
    public UserFollowerFollowingDto getUserFollower(Long userId) {
        return getUserFollower(userId, null);
    }

    @Override
    public UserFollowerFollowingDto getUserFollowing(Long userId, UserFollowerFollowingRequestParameterDto search) {
        return webClient
                .get()
                .uri(
    ...
    @Override
    public UserFollowerFollowingDto getUserFollowing(Long userId) {
